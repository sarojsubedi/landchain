...
const SuperAdmin = (props) => {
    ...
    const handleSubmit = async () => {
        await contract.addAdmin(adminData.address, adminData.province, adminData.district, adminData.city, {
            from: account
        })

        console.log('admin details submitted');
        setAdminData({ address: "", province: "", district: "", city: "" });
    }
        ...
        <div className='container superAdmin-mainDiv'>
            ...
            <form method='POST' className='admin-form'>
                <div className='form-group'>
                    ...
                    <input type="text" className="form-control" name="address" placeholder="Enter admin ethereum address"
                        autoComplete="off" value={adminData.address} onChange={onChangeFunc} />
                </div>
                <div className='form-group'>
                    <label>Province</label>
                    <select name="province" className="form-control" value={adminData.province} onChange={onChangeFunc}>
